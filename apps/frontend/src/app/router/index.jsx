    ...
    <Routes>
      ...
      <Route element={<ProtectedRoute />}>
        <Route element={<AppShell />}>
          ...
          {/* Purchase Orders (View) - accessible by Main Master, Supervisor, Purchase Accountant, Receiver */}
          ...
          {/* Create PO - accessible by Main Master, Purchase Accountant */}
          ...
          {/* GRN Module - View: Master, Supervisor, Receiver, Lab Asst */}
          <Route element={<RoleGuard allowedRoles={['MAIN_MASTER', 'SUPERVISOR', 'MATERIALS_RECEIVER', 'LAB_ASSISTANT']} />}>
            <Route path="/grn" element={<PlaceholderPage title="GRN" />} />
          </Route>

          {/* RM Management */}
          <Route element={<RoleGuard allowedRoles={['MAIN_MASTER', 'MATERIALS_RECEIVER']} />}>
            <Route path="/rm/stock" element={<PlaceholderPage title="RM Stock" />} />
            <Route path="/rm/wastage" element={<PlaceholderPage title="RM Wastage" />} />
          </Route>

          {/* Lab Management */}
          <Route element={<RoleGuard allowedRoles={['MAIN_MASTER', 'MATERIALS_RECEIVER', 'LAB_ASSISTANT']} />}>
            <Route path="/lab/pending" element={<PlaceholderPage title="Pending RM Lab Tests" />} />
          </Route>
          <Route element={<RoleGuard allowedRoles={['MAIN_MASTER', 'LAB_ASSISTANT', 'SUPERVISOR']} />}>
            <Route path="/lab/results" element={<PlaceholderPage title="RM Lab Results" />} />
          </Route>
          ...
          {/* Admin only routes (User Mgmt, Roles, etc.) */}
          <Route element={<RoleGuard allowedRoles={['MAIN_MASTER']} />}>
