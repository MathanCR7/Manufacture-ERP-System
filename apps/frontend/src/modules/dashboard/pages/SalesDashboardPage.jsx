  ...
  return (
    <div className="space-y-6 bg-[#F4F3FF] dark:bg-slate-950 -m-4 sm:-m-6 lg:-m-8 p-4 sm:p-6 lg:p-8 min-h-screen">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-xl font-black text-slate-800 dark:text-slate-100">🧾 Sales Dashboard</h1>
          <p className="text-xs text-slate-400 dark:text-slate-500 mt-0.5">Real-time sales performance & order tracking</p>
        </div>
